...
//Since we are dealing with Java files you must make sure to close each complete code statement withe Semi Colon or it will not work you must make sure all of the brackets and braces match up in the end otherwise code WILL BE LOST TRUST I LEARNED THE HARD WAY!
...
public class happydays extends LinearOpMode {
}
...
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name="CompetitoncodeV3", group="Linear Opmode")
public class CompetitoncodeV3 extends LinearOpMode {
...
//I have no idea ho w this works if were being Totally honest ALl I knowis that it does We really will never have to mess with these statements for the most part
        ...
        while (opModeIsActive()) {
            ...
            leftfront.setPower(leftPower * 0.85);
...
*/
            ...
            if (gamepad2.a) {
                flywheel.setPower(120);
                secondflywheel.setPower(120);  // full speed forward
            } else {

                flywheel.setPower(0);
                secondflywheel.setPower(0);    // stop when x is not pressed
            }

            if (gamepad2.b) {
                flywheel.setPower(130);
                secondflywheel.setPower(130);// full speed forward
            } else {
                flywheel.setPower(0);
                secondflywheel.setPower(0);    // stop when x is not pressed
            }
